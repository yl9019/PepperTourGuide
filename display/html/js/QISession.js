...
let {XMLHttpRequest} = require("/home/tm/EIE4/hcr/app/node_modules/xmlhttprequest/lib/XMLHttpRequest");
...
(function (exports, io, global) {
  ...
  Socket.prototype.handshake = function (fn) {
    ...
    if (false && this.isXDomain() && !io.util.ua.hasCORS) {
      ...
      var xhr = new XMLHttpRequest();//io.util.request();
...
let fn = (session) => {
  console.log("Hello!");
  session.service("ALTextToSpeech").then((serv) => serv.say("Hello!"));
}

console.log("STARTING !!")

QiSession(fn, () => {}, "http://192.168.0.101");
