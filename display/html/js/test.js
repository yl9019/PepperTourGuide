...
/** @constructor */
function $c_LFloorState$() {
  this.LFloorState$__f_canvas = null;
  this.LFloorState$__f_mapImg = null;
  this.LFloorState$__f_mapReady = false;
  this.LFloorState$__f_c2d = null;
  this.LFloorState$__f_data = null;
  this.LFloorState$__f__lvl = null;
  $n_LFloorState$ = this;
  document.getElementById("left-pane");
  this.LFloorState$__f_canvas = document.getElementById("right-canvas");
  this.LFloorState$__f_mapImg = document.createElement("img");
  this.LFloorState$__f_mapReady = false;
  window.onresize = (function(this$1) {
    return (function(_$1) {
      this$1.updateCnv__V()
    })
  })(this);
  this.updateCnv__V();
  this.LFloorState$__f_mapImg.onload = (function(this$2) {
    return (function(e) {
      this$2.LFloorState$__f_mapReady = true;
      this$2.redrawCnv__V()
    })
  })(this);
  this.LFloorState$__f_c2d = this.LFloorState$__f_canvas.getContext("2d");
  var fields = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T2.getArrayOf().constr)([new $c_T2("width", 0), new $c_T2("height", 0), new $c_T2("ox", 0), new $c_T2("oy", 0)]));
  this.LFloorState$__f_data = $m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields);
  this.LFloorState$__f__lvl = $m_s_None$()
}
$c_LFloorState$.prototype = new $h_O();
$c_LFloorState$.prototype.constructor = $c_LFloorState$;
/** @constructor */
function $h_LFloorState$() {
  /*<skip>*/
}
$h_LFloorState$.prototype = $c_LFloorState$.prototype;
$c_LFloorState$.prototype.redrawCnv__V = (function() {
  var x = ((((((("Drawing Image! " + (($uI(this.LFloorState$__f_canvas.width) - this.mapDim__I()) | 0)) + ", ") + (($uI(this.LFloorState$__f_canvas.height) - this.mapDim__I()) | 0)) + ", ") + this.mapDim__I()) + ", ") + this.mapDim__I());
  var this$2 = $m_s_Console$();
  var this$3 = $n(this$2.out__Ljava_io_PrintStream());
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  var $$x1 = this.LFloorState$__f_c2d;
  var x$1 = $uI(this.LFloorState$__f_canvas.width);
  var x$2 = $uI(this.LFloorState$__f_canvas.height);
  $$x1.clearRect(0.0, 0.0, x$1, x$2);
  var $$x3 = this.LFloorState$__f_c2d;
  var $$x2 = this.LFloorState$__f_mapImg;
  var x$3 = (($uI(this.LFloorState$__f_canvas.width) - this.mapDim__I()) | 0);
  var x$4 = (($uI(this.LFloorState$__f_canvas.height) - this.mapDim__I()) | 0);
  var x$5 = this.mapDim__I();
  var x$6 = this.mapDim__I();
  $$x3.drawImage($$x2, x$3, x$4, x$5, x$6)
});
$c_LFloorState$.prototype.updateCnv__V = (function() {
  this.LFloorState$__f_canvas.width = $uI(this.LFloorState$__f_canvas.clientWidth);
  this.LFloorState$__f_canvas.height = $uI(this.LFloorState$__f_canvas.clientHeight);
  if (this.LFloorState$__f_mapReady) {
    this.redrawCnv__V()
  }
});
$c_LFloorState$.prototype.mapDim__I = (function() {
  var x = $uI(this.LFloorState$__f_canvas.width);
  var that = $uI(this.LFloorState$__f_canvas.height);
  return ((x < that) ? x : that)
});
$c_LFloorState$.prototype.lvl_$eq__s_Option__V = (function(x) {
  this.LFloorState$__f__lvl = x;
  this.LFloorState$__f_c2d.fillStyle = "#FFFFFF";
  var $$x1 = this.LFloorState$__f_c2d;
  var x$1 = this.mapDim__I();
  var x$2 = this.mapDim__I();
  $$x1.fillRect(0.0, 0.0, x$1, x$2);
  this.LFloorState$__f_mapReady = false;
  this.LFloorState$__f_mapImg.src = (("maps/map" + $n(this.LFloorState$__f__lvl).get__O()) + ".png");
  var xhr = new XMLHttpRequest();
  xhr.open("GET", "data/map_data.json");
  xhr.onload = (function(this$4) {
    return (function(e) {
      if (($uI(xhr.status) === 200)) {
        this$4.LFloorState$__f_data = JSON.parse($as_T(xhr.responseText));
        var x$3 = $as_T(JSON.stringify(this$4.LFloorState$__f_data));
        var this$6 = $m_s_Console$();
        var this$7 = $n(this$6.out__Ljava_io_PrintStream());
        this$7.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x$3 + "\n"));
        return (void 0)
      } else {
        return (void 0)
      }
...
var $d_LFloorState$ = new $TypeData().initClass({
  LFloorState$: 0
}, false, "FloorState$", {
  LFloorState$: 1,
  O: 1
});
$c_LFloorState$.prototype.$classData = $d_LFloorState$;
var $n_LFloorState$;
function $m_LFloorState$() {
  if ((!$n_LFloorState$)) {
    $n_LFloorState$ = new $c_LFloorState$()
  };
  return $n_LFloorState$
}
/** @constructor */
...
$c_LMain$package$.prototype.startFloorUpdate__sjs_js_timers_SetIntervalHandle = (function() {
  return $m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(2500.0, new $c_sjsr_AnonFunction0((function() {
    var xhr = new XMLHttpRequest();
    ...
    xhr.onload = (function(e) {
      if (($uI(xhr.status) === 200)) {
        ...
        var resp = $m_sc_StringParsers$().parseInt__T__s_Option(x);
        var this$4 = $n(resp);
        if ((!this$4.isEmpty__Z())) {
          var x$2 = $m_LFloorState$().LFloorState$__f__lvl;
          var $$x1 = (!((resp === null) ? (x$2 === null) : $n(resp).equals__O__Z(x$2)))
        } else {
          var $$x1 = false
        };
        if ($$x1) {
          var x$1 = ((("Floor: " + $m_LFloorState$().LFloorState$__f__lvl) + " => ") + resp);
          var this$6 = $m_s_Console$();
          var this$7 = $n(this$6.out__Ljava_io_PrintStream());
          this$7.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x$1 + "\n"));
          $m_LFloorState$().lvl_$eq__s_Option__V(resp);
          return (void 0)
        } else {
          return (void 0)
        }
...
$c_LMain$package$.prototype.startPositionUpdate__sjs_js_timers_SetIntervalHandle = (function() {
  return $m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(2500.0, new $c_sjsr_AnonFunction0((function() {
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "data/map_probs");
    xhr.onload = (function(e) {
      if (($uI(xhr.status) === 200)) {
        var x = ("Resp: " + $as_T(xhr.responseText));
...
$c_LMain$package$.prototype.main__sjs_js_timers_SetIntervalHandle = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $n(this$2.out__Ljava_io_PrintStream());
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("STARTING!!\n");
  $m_LMain$package$().startFloorUpdate__sjs_js_timers_SetIntervalHandle();
  return $m_LMain$package$().startPositionUpdate__sjs_js_timers_SetIntervalHandle()
});
...
function $s_Lmain__main__AT__V(args) {
  try {
    $m_LMain$package$().main__sjs_js_timers_SetIntervalHandle()
  } catch (e) {
    if (false) {
  ...
  while (true) {
    if ((i === len$2)) {
      ...
      if (((digit === (-1)) || ((agg === (-214748364)) && (digit === 9)))) {
        ...
        var temp$i = ((1 + i) | 0);
        var temp$agg = (($imul(10, agg) - digit) | 0);
        i = temp$i;
        agg = temp$agg
      }
    }
...
$c_sjs_js_special_package$.prototype.objectLiteral__sci_Seq__sjs_js_Object = (function(properties) {
  var result = {};
  $n(properties).foreach__F1__V(new $c_sjsr_AnonFunction1((function(pair$2) {
